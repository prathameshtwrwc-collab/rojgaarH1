...
export default function EmployerLogin() {
  ...
  const from = (location.state as { from?: { pathname: string } })?.from?.pathname || '/dashboard/employer';
    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--bg-warm)] px-4">
      <div className="w-full max-w-[460px]">
        <div className="bg-white rounded-2xl shadow-lg p-8">
          <AuthSwitcher active="login" role="employer" />
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-[var(--charcoal)]">
              ...
              <Link to="/register/employer" className="text-[var(--orange)] font-semibold hover:underline">
                Register company
              </Link>
            </p>
          </div>
